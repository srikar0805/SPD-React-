...
const ProfileStatNetworth = () => {
  ...
  for (let i = 0; i < tblData.length; i++) {
    networth = networth + parseInt(tblData[i][5]);
  }

  return (
    <div>
        <span style={{fontWeight: "bold", fontSize: "30px"}}>₹{networth}</span>
    </div>
    );
};

export default ProfileStatNetworth;
